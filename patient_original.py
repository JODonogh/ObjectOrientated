...
class Patient:
    ...
    def insert_patient(self):
        ...
        sll.insert_start(self.patient_id, 0)
    ...
    def get_condition(self):
        patient_condition = input("Please enter the assessment of the patients condition:")
        return patient_condition

    def get_vitals(self):
        patient_vitals= input("Please enter the patients vitals:")
    ...
    def get_treatment(self):
        patient_treatment = input("Please enter the suggested treatment for the patient: ")
